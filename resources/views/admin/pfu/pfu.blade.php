...
<div class="topbar sticky d-flex align-items-center justify-content-between animate__animated animate__fadeInDown">
    ...
    @canany(['save-pfu'])
        <button class="btn btn-sm btn-primary animate__animated animate__fadeIn" data-bs-toggle="modal" data-bs-target="#addPfuDialog">
            Add
...
<!-- Modal to add pfu -->
<div class="modal fade" id="addPfuDialog" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="addPfuDialogLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <form id="addPfuForm" class="modal-content">
        ...
        <div class="modal-body pfuModal" style="max-width: 700px">
            <div class="d-flex align-items-center flex-wrap">
                <div class="d-flex justify-content-center align-items-center innerSection relative">
                    ...
                    <img src="{{asset('assets/images/vendor.svg')}}" alt="" onclick="resetFrom()" class="animate__animated animate__fadeIn" />
                </div>
                <div class="d-flex flex-wrap innerSection">
                    ...
                    <div class="form-group">
                        ...
                        <input name="domain" type="text" class="form-control" placeholder="eg. frontiers.com" required />
                        <svg xmlns="http://www.w3.org/2000/svg" class="inputIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-sm btn-primary animate__animated animate__fadeInUp" id="pfuSubmitButton">
                <span>Submit</span>
