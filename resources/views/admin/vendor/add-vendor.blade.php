        ...
        <form id="addVendorForm">
            <div class="formRow pt-0">
                <div class="form-group" style="flex: 2; min-width: 46%">
                    ...
                    <input name="companyName" type="text" id="companyName" class="form-control" placeholder="Name here" required autofocus/>
                </div>
                ...
                <div class="form-group" style="flex: 1 1 260px">
                    ...
                    <input name="vendorCode" type="text" id="vendorCode" class="form-control" placeholder="Holder Name here" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px">
                ...
                <div class="form-group" style="flex: 1 1 260px">
                    ...
                    <input name="pincode" type="text" id="pincode" class="form-control number" maxlength="6" pattern="^[1-9][0-9]{5}$" placeholder="XXXXXX" required />
                </div>
                <div class="form-group" style="width: 100%">
                    <label for="vendorAddress" class="form-label">Address</label>
                    <textarea name="vendorAddress" id="vendorAddress" class="form-control" placeholder="address here..." required ></textarea>
                </div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="form-group" style="flex: 1 1 260px">
                    ...
                    <input name="contactPersonName" type="text" id="contactPersonName" class="form-control" placeholder="Name here" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px">
                    <label for="contactPersonDesignation" class="form-label">Designation</label>
                    <input name="contactPersonDesignation" type="text" id="contactPersonDesignation" class="form-control" placeholder="Holder Name here" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px">
                    <label for="contactPersonMobile" class="form-label">Mobile</label>
                    <input name="contactPersonMobile" pattern="^[9876][0-9]{9}$" type="text" id="contactPersonMobile" class="form-control number" maxlength="10" placeholder="XXXX XXX XXX" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px">
                    <label for="contactPersonEmail" class="form-label">Primary Email</label>
                    <input name="contactPersonEmail" pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" type="text" id="contactPersonEmail" class="form-control" placeholder="e.g. email@your.domai" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px">
                    <label for="contactPersonAltEmail" class="form-label">Secondary Email</label>
                    <input name="contactPersonAltEmail" pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" type="text" id="contactPersonAltEmail" class="form-control" placeholder="e.g. email@your.domai" />
                </div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="form-group" style="flex: 1 1 260px; min-width: 40%">
                    ...
                    <input name="ownerName" type="text" id="ownerName" class="form-control" placeholder="Name here" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px; min-width: 40%">
                ...
                <div class="form-group" style="flex: 1 1 260px; min-width: 40%">
                    ...
                    <input name="msmeNumber" type="number" id="msmeNumber" class="form-control" placeholder="XXXXXXXXXX" required />
                </div>
                <div class="form-group" style="flex: 1 1 260px; min-width: 40%">
                    <label for="gstNumber" class="form-label">GSTIN</label>
                    <input name="gstNumber" max-length="11" type="text" id="gstNumber" maxlength="16" class="form-control" placeholder="XXXXXXXXXX" required />
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-end" style="gap: 1.5rem">
                <button type="button" class="btn btn-sm btn-secondary animate__animated animate__fadeInUp discard" onclick="resetForm()" style="min-width: 100px">
                    Discard
                </button>
                <button type="submit" class="btn btn-sm btn-primary animate__animated animate__fadeInUp" id="vendorSubmitButton">
                    <span>Submit</span>
    ...
    // })
     ...
     $("#addVendorForm").validate({
        rules: {
            ...
            natureOfAssesse:  {required: true},
            vendorCode:  {required: true, minlength: 5 },
            state:  {required: true},
            pincode:  {required: true, maxlength: 6 },
            vendorAddress:  {required: true},
            contactPersonName:  {required: true},
            contactPersonDesignation:  {required: true},
            contactPersonMobile:  {required: true, minlength: 10 },
            contactPersonEmail:  {required: true},
            contactPersonAltEmail:  {required: true},
            accountNumber:  {required: true},
            ifsc:  {required: true, minlength: 11 },
            branch:  {required: true},
            bankName:  {required: true},
            holderName:  {required: true},
            ownerName:  {required: true},
            natureOfService:  {required: true},
            msmeNumber:  {required: true},
            gstNumber:  {required: true, minlength: 16, maxlength: 16 }
        },
        messages: {
           companyName:  {required: 'Required'},
            natureOfAssesse:  {required: 'Required'},
            vendorCode:  {required: 'Required', minlength: 'Minimum 5 characters required'},
            state:  {required: 'Required'},
            pincode:  {required: 'Required'},
            vendorAddress:  {required: 'Required'},
            contactPersonName:  {required: 'Required'},
            contactPersonDesignation:  {required: 'Required'},
            contactPersonMobile:  {required: 'Required', length: 'Enter a valid mobile number'},
            contactPersonEmail:  {required: 'Required'},
            contactPersonAltEmail:  {required: 'Required'},
            accountNumber:  {required: 'Required'},
            ifsc:  {required: 'Required', minlength: 'Enter a valid ifsc code'},
            branch:  {required: 'Required'},
            bankName:  {required: 'Required'},
            holderName:  {required: 'Required'},
            ownerName:  {required: 'Required'},
            natureOfService:  {required: 'Required'},
            msmeNumber:  {required: 'Required'},
            gstNumber:  {required: 'Required', minlength: 'Enter a valid gstin number', maxlength: 'Enter a valid gstin number' }
        },
