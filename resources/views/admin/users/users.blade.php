                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control form-select @error('roles') is-invalid @enderror"
                                aria-label="Roles" id="roles" name="roles[]" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="pfu" class="pfu form-control" id="pfu" required />
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input name="mobile" class="form-control number" placeholder="XXXX XXX XXX"
                                pattern="^[9876][0-9]{9}$" maxlength="10" required />
                            <span class="error" id="mobileError"></span>
                        </div>
                        <div class="form-group">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" id="email" name="email"
