...
<div class="topbar sticky d-flex align-items-center justify-content-between animate__animated animate__fadeInDown">
    ...
    <div class="actionButtonsBlock flex-grow-1 d-flex align-items-center justify-content-end">
        ...
        <a id="exportMyLedger" href="{{ url('/export-users') }}" class="btn btn-sm btn-primary animate__animated animate__fadeIn">
            Export
            <svg xmlns="http://www.w3.org/2000/svg" class="icon right" width="24" height="24" viewBox="0 0 24 24"
...
<!-- Modal to add user -->
<div class="modal fade" id="addUserDialog" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="d-flex align-items-center flex-wrap">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="pfu" class="pfu form-control" required />
    ...
    $('.edit_user').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                initiatePfuSelect('#edit_pfu', selectOptions.length, selectOptions);
            },
