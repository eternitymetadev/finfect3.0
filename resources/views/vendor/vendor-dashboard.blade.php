...
<div class="widgetsBlock">
    <div class="widget listing">
        ...
        @for ($i = 0; $i < 5; $i++) <div class="listItem">
            <div class="basic">
...
<div class="contentSection pt-3 mt-3">
    <div class="animate__animated animate__fadeIn">
        @if(count($vendorsList) <= 0) <div class="noDataView">
    ...
    <div class="tableContainer">
        ...
        <!-- topbar -->
        <div
            class="topbar d-flex align-items-center justify-content-between animate__animated animate__fadeInDown mb-4">
            <div class="flex-grow-1 d-flex align-items-center justify-content-start">
                <div class="searchInputBlock form-group animate__animated animate__fadeIn">
                    ...
                    <input type="search" class="keywordSearch form-control form-control-sm withIcon"
                        placeholder="search..." />
                </div>
            </div>
            <div class="actionButtonsBlock flex-grow-1 d-flex align-items-center justify-content-end">
                <button class="btn btn-sm btn-primary animate__animated animate__fadeIn" data-bs-toggle="modal"
                    data-bs-target="#vendorsUploadDialog">
                    Import
                    ...
                    <tr>
                        ...
                        <td class="actionCol text-center">
                            <div class="iconButtonsContainer d-flex align-items-center justify-content-center"
                                style="gap: 0.5rem">
                                <a class="iconButton viewVendorDetails" data-id="{{$vendor->id}}">
                                ...
                                @canany(['edit-vendor'])
                                <a class="iconButton edit_pfu"
                                    href="{{url('/edit-vendor/'.Crypt::encrypt($vendor->id))}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
<div class="modal fade" id="vendorsUploadDialog" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="vendorsUploadDialogLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-width: 600px">
                <div class="uploadFormDialog">
                    ...
                    <button class="btn btn-primary animate__animated animate__fadeInUp" id="vendorUploadButton">
                        Upload
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon right" width="24" height="24"
...
<div class="modal fade" id="viewvendorDialog" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="viewvendorDialogLabel" aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="details">
                        ...
                        <div class="detailBlock">
                            ...
                            <div class="detailDesBlock">
                                <div class="detailDes">
                                    <span>Email ID</span>
                                    :
                                    <span class="email">santisaini169@gmail.com</span>
                                </div>

                                <div class="detailDes">
                                    <span>Phone No.</span>
                                    :
                                    <span class="mobile">+91 9991162810</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="detailBlock">
                            ...
                            <div class="detailDesBlock">
                                <div class="detailDes">
                                    <span>PAN No.</span>
                                    :
                                    <span class="pan">ECKPK5705G</span>
                                </div>
                                <div class="detailDes">
                                    <span>GSTIN</span>
                                    :
                                    <span class="gst">06ECKPK5705G1ZL</span>
                                </div>
                                <div class="detailDes">
                                    <span>MSME No.</span>
                                    :
                                    <span class="msme">432KPK5705G323</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="detailBlock">
                            ...
                            <div class="detailDesBlock">
                                <div class="detailDes">
                                    ...
                                    :
                                    <span class="ownerName">Santi Saini</span>
                                </div>
                                <div class="detailDes">
                                    <span>Address</span>
                                    :
                                    <span class="address">Bestech Business Tower, Sector 66, Mohali, Punjab
                                        160062</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="bankCard animate__animated animate__fadeIn">
                            <img src="http://localhost:8000/assets/images/logo.svg" alt="bank logo"
                            ...
                            <div class="bankDetail animate__animated animate__fadeIn">
                                <div class="detailItem d-flex align-items-center">
                                    ...
                                    <span class="value flex-grow-1 acc_holder_name">: Anil Wires &amp; Cables</span>
                                </div>
                                <div class="detailItem d-flex align-items-center">
                                    <span class="key">A/c Number</span>
                                    <span class="value flex-grow-1 acc_num">: 0353104000163361</span>
                                </div>
                                <div class="detailItem d-flex align-items-center">
                                    <span class="key">Branch</span>
                                    <span class="value flex-grow-1 branch">: Hisar, Haryana</span>
                                </div>
                                <div class="detailItem d-flex align-items-center">
                                    <span class="key">IFSC</span>
                                    <span class="value flex-grow-1 ifsc">: IBKL0000353</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <hr class="m-0" />
                        <div id="docBlock" class="docBlock animate__animated animate__fadeIn">
                    ...
                    <div>
                        ...
                        <div class="statesBlock animate__animated animate__fadeIn">
                            <span class="chip v_state">HP</span>
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button class="btn btn-sm actionButton reject animate__animated animate__fadeIn">
                    Reject
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon right" width="16" height="16"
                        viewBox="0 0 16 16" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M8.54321 0C12.9585 0 16.5432 3.58467 16.5432 8C16.5432 12.4153 12.9585 16 8.54321 16C4.12788 16 0.543213 12.4153 0.543213 8C0.543213 3.58467 4.12788 0 8.54321 0ZM3.33788 3.82167C2.41821 4.966 1.86755 6.419 1.86755 8C1.86755 11.6843 4.85888 14.6757 8.54321 14.6757C10.1242 14.6757 11.5772 14.125 12.7212 13.2053L3.33788 3.82167ZM13.6872 12.2533C14.6439 11.098 15.2192 9.61567 15.2192 8C15.2192 4.31533 12.2279 1.324 8.54321 1.324C6.92755 1.324 5.44521 1.89933 4.28988 2.856L13.6872 12.2533Z"
                            fill="#FFF1F5" />
                    </svg>
                </button>
...
$(document).ready(function() {
    ...
    $('#vendorUploadButton').click(function() {
        ...
        let fileInput = $('#upload_vendor')[0].files[0];
        formData.append('upload_vendor', fileInput);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#vendorUploadButton').html('Update');
                    $('#vendorUploadButton').removeAttr('disabled');
            ...
            error: function(xhr, status, error) {
                ...
                let newDate = '20 Nov 2023 13:30:00';
                $('#vendorUploadButton').html('Submit');
                $('#vendorUploadButton').removeAttr('disabled');
                $('.uploadFormDialog').css("pointer-events", "all");
                $('.helperText').html(`Last Updated: ${newDate}`);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    var base_url = response.awsUrl;
                    console.log(base_url);
                    console.log(vendorDetail);
                    $('.vendorName > span').html(vendorDetail.company_name);
                    $('.vendorCode').html(vendorDetail.erp_code)
                    $('.email').html(vendorDetail.primary_email)
                    $('.mobile').html(vendorDetail.mobile)
                    $('.msme').html(vendorDetail.msme_number)
                    $('.pan').html(vendorDetail.pan)
                    $('.gst').html(vendorDetail.gst)
                    $('.ownerName').html(vendorDetail.owner_name)
                    $('.address').html(vendorDetail.address)
                    $('.acc_holder_name').html(vendorDetail.acc_holder_name)
                    $('.acc_num').html(vendorDetail.acc_no)
                    $('.branch').html(vendorDetail.branch_name)
                    $('.ifsc').html(vendorDetail.ifsc_code)
                    $('.v_state').html(vendorDetail.state)

                    function generateImageContainer(title, imageUrl) {
                        if (imageUrl) {
                            return `
                        <a class="imageContainer" href="${base_url}/${imageUrl}" target="_blank">
                            <span class="animate__animated animate__fadeIn">${title}</span>
                            <img src="${base_url}/${imageUrl}" alt="doc" />
                        </a>
                        `;
                        }
                        return '';
                    ...
                    const images = `
                    ${generateImageContainer('PAN', vendorDetail.upload_pan)}
                    ${generateImageContainer('GSTIN', vendorDetail.gst_certificate)}
                    ${generateImageContainer('MSME Certificate', vendorDetail.msme_certificate)}
                    ${generateImageContainer('Cancel Cheque', vendorDetail.cancel_cheque)}
                `;

                    $('#docBlock').html(images);
                } else {
